...
def main():
    ...
    url = 'https://github.com/DataTalksClub/nyc-tlc-data/releases/download/misc/'
    file_format = '.csv'
    # taxi_dtypes = {
    ...
    for file in file_list:
        ...
        df_iter = pd.read_csv(filepath_or_buffer=f'{url}{file}{file_format}',sep=',', iterator=True,chunksize=100000)
        # print(df.columns)
        r_end = time()
